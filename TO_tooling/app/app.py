...
class App(QtWidgets.QApplication):
    def __init__(self):
        ...
        self._main_window.setWindowFlags(self._main_window.windowFlags() | QtCore.Qt.WindowType.FramelessWindowHint)
        self._main_window.setAttribute(QtCore.Qt.WidgetAttribute.WA_TranslucentBackground)
